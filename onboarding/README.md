...
[![OpenAI CEO, CTO on risks and how AI will reshape society](https://img.youtube.com/vi/540vzMlf-54/0.jpg)](https://youtu.be/540vzMlf-54)  
...
원문: 최창현 기자 [aitimes@naver.com](aitimes@naver.com)  
  
---  
  
### 작성자: 정용은  
  
### 뉴스 요약: GPT-4를 발표한 오픈 AI 샘 알트만 CEO의 AI 가 사회에 미치는 영향에 대한 의견과 GPT-4가 이전 버전인 GPT-3.5에 비해 어떤 점이 향상되었는지 분석하는 뉴스  
  
### 느낀 점: 본인도 GPT-4가 발표된 이후로 구글 검색엔진 사용 빈도가 전보다 줄고 챗GPT를 사용하는 경우가 많아졌다. 결국 이 기사에서 언급한 것처럼, AI 가 우리 생활에 미치는 영향은 생각보다 훨씬 더 빠르다고 느꼈고, 알트만의 언급처럼 이 기술을 악의적인 용도로 사용하려는 부분에 대한 법적인 규제나 제한이 없다면 향후 인류에게 큰 위협이 될 수 있겠다고 생각했다. 그래도 이러한 발전이 사람들에게 지금보다 더 나은 생활로 나아갈 수 있는 계기가 될 거라 믿고, 즐기면서 AI 모델 개발을 하고 싶다는 생각을 한다.  
 ...
 *이은영*
 ...
 ### 뉴스 요약 : 
 대화형 생성 인공지능(Generative AI) 챗GPT(ChatGPT)의 오픈AI **CEO 샘 알트만(Sam Altman)** 는 인공지능 기술이 우리가 알고 있는 사회를 재구성할 것이라며, 실제 위험이 따르지만 우리의 삶을 획기적으로 개선하기 위해 "인류가 지금까지 개발한 가장 위대한 기술"이 될 수도 있다고 믿는다고 밝혔습니다.
 
 
 ### 느낀점 : 
 뉴스의 전반적인 내용은 챗GPT의 상용화에 따라 발생할 문제에 대한 우려로 느껴집니다. 챗GPT에 대한 정보 의존성과 일자리 대체 가능성이 가장 큰 문제인 것 같습니다. 인터넷이 없으면 살 수 없게된 지금처럼 몇년 후엔 챗GPT없인 살 수 없게될 것 같습니다. 이러한 정보 의존성에 대해 경계할 필요가 있겠습니다. 일자리 문제는 지금도 해결되지 않은 문제이기에 앞으로 인간만이 할 수 있는 직업이 무엇인지, 기계가 대체할 수 없는 분야가 무엇인지.. 고민해볼만한 문제인 것 같습니다.
